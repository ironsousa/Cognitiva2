# -*- coding: utf-8 -*-
"""Cognitiva2_InterfaceVoz.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zlbFK9RxTSU4nqlZqo4dqYw3VwJkV3xE
"""
...
with open('bianca-python-assistente-09e4083594e1.json') as credenciais_google:
...
def publica_mqtt(topic, payload):
    publish.single(topic, payload=payload, qos=1, retain=True, hostname='m10.cloudmqtt.com', port=12892, client_id='bianca', auth={'username': 'xxxxxxxx', 'password': 'xxxxxxxx'})
    if payload == '1':
